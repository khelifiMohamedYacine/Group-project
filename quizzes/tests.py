...
class AdminViewsTests(TestCase):
    ...
    - admin_quiz_view() (from views.py in core_app)
    """

    def test_admin_quiz_access(self):
        """
        Tests that only admin accounts can access the Manage Quizzes page.
        ...
        # The user should be allowed through to the Manage Quizzes page, and the status code should be 200.